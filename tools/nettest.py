...
def main() -> None:
    ...
    if direct:
        ...
        if found:
            ...
            print("  هیچ پورتی هم باز نبود — یعنی برنامه‌ی پروکسی یا خاموش")
            print("  است، یا روشن است ولی هسته‌اش بالا نیامده.")
            print("\n  اول لاگ خودِ برنامه را ببینید. اگر خطای FATAL دارد:")
            print("    · «tun-in … configure tun interface» ← حالت TUN را")
            print("      خاموش کنید. شکستِ TUN کل هسته را می‌خواباند، پس")
            print("      پورت SOCKS هم باز نمی‌شود.")
            print("    · بعد پورت SOCKS را از نوار پایین برنامه بردارید و")
            print("      در .env بگذارید:")
            print(f"\n       PROXY_URL={scheme}://127.0.0.1:<همان پورت>\n")
            print("  در v2rayN پیش‌فرض ۱۰۸۰۸ است، در Hiddify «پورت ترکیبی».")
            print("  مسیریابی را هم روی Global بگذارید، وگرنه تلگرام ممکن")
            print("  است «داخلی» حساب شود و از تونل رد نشود.")
        sys.exit(1)
