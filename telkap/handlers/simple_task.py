...
MODE_COMPARISON = (
    ...
    "می‌کنید. همین — بعدش همه‌چیز همان‌طور کار می‌کند.\n\n"
    # <b>شرطِ QR همین‌جا گفته می‌شود، نه دو صفحه بعد.</b> کد را نمی‌شود
    # با دوربینِ همان گوشی‌ای که نشانش می‌دهد اسکن کرد؛ کسی که فقط یک
    # گوشی دارد باید از همین‌جا بداند راهِ او کدام است، وگرنه می‌رود
    # سراغ QR و به بن‌بست می‌خورد.
    "• <b>فقط یک گوشی دارید؟</b> با شماره و کد وارد می‌شوید — کد را "
    "تلگرام می‌فرستد و همان‌جا در ربات واردش می‌کنید.\n"
    "• <b>کامپیوتر یا دستگاه دوم دارید؟</b> کد QR را با آن اسکن "
    "می‌کنید و اصلاً چیزی تایپ نمی‌کنید."
)
